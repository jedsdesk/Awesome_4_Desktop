...
local mytextclock = wibox.widget.textclock(markup(blue, " %a")
.. markup(white, " %d ") .. markup(blue, "%b ") ..  markup(white, "%H:%M "))
...
function theme.at_screen_connect(s)
	...
	local layouts = { l.max, l.tile, l.tile, l.corner.se, l.tile.bottom, l.corner.se, l.magnifier, l.floating, l.floating, }
